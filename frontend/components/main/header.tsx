      ...
      <div className="flex items-center bg-white/5 backdrop-blur-lg border border-white/10 rounded-full p-2">
        <div className="relative">
          ...
          <input
            ...
            className="bg-transparent pl-9 text-sm focus:outline-none text-white"
          />
        </div>
        <div className="flex items-center space-x-4 ml-4">
          ...
          <a href="#">
            <Settings className="h-5 w-5 text-gray-400 hover:text-white active:animate-spin" />
          </a>{" "}
          {/* I like the spin animation, dont remove it. -Abhash */}
          <a href="#">
